...
public class BoardingForm
{
    ...
    {
        return
            $"BoardingForm: {Id}, BoardedAnimal: {BoardedAnimal}, StartDate: {StartDate}, EndDate: {EndDate}, PaymentType: {PaymentType}, Price: {Price}";
    }

    public static BoardingForm Create(BoardedAnimal boardedAnimal, DateTime startDate, DateTime endDate,
        PaymentType paymentType, decimal price)
    {
